...
summary: "Revolutionary 3D recruitment experience combining immersive WebGL graphics with advanced AI personas. Transforms traditional portfolio browsing into interactive conversations, achieving 85% recruiter engagement and 3x longer session times."
images:
...
technologies:
  ...
  - "WebGL"
metrics:
  engagement: "85% recruiter engagement"
  session_time: "3x longer sessions"
  response_accuracy: "92% contextual accuracy"
  load_time: "<2s initial load"
  personas: "3 specialized AI variants"
  conversations: "500+ simulated interviews"
team:
  - name: "Naoise Law"
...
downloads:
  - label: "Live Demo"
    href: "https://naoiselaw.com/simulator"
    size: "Interactive Experience"
  - label: "Technical Architecture"
    href: "/downloads/simulator/architecture.pdf"
    size: "2.1 MB"
---
